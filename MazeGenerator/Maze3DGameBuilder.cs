...
namespace MazeGenerator
{
    ...
    public class Maze3DGameBuilder
    {
        ...
        public void Build()
        {
            ...
            Maze3DLevelBuilder mazeBuilder = new Maze3DLevelBuilder(sb);
            ...
            sb.AppendLine(@"transform = Transform3D(1, 0, 0, 0, 1, 0, 0, 0, 1, 27, 127 , 37)");
            ...
            File.WriteAllText("../../../Labyrinth3D_2.tscn", sb.ToString());
        }
    }
}